(function () {
	...
	function toggle(state, attrs, itemnr, type) {
	    ...
	    var $item = (_a = document.querySelector("#acc-item-" + itemnr)) !== null && _a !== void 0 ? _a : null;
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("section", { class: "accordion" }, (_b = attrs.items) === null || _b === void 0 ? void 0 : _b.map(function (item, index) {
	            ...
	            var maxHeight = (type === 'primary' && openPrimary.maxheight)
	                ...
	                || 0;
	            return (mithril("article", { id: "acc-item-" + index, class: "acc-item acc-" + type },
	                mithril("a", { href: "javascript:", onclick: function () { return toggle(state, attrs, index, type); }, class: "acc-opener " + (type === 'secondary' ? 'acc-opener--grayed' : '') },
	                    mithril("span", null,
	                        mithril("i", { class: "fas fa-" + fas + " mr1" }),
	                        " ",
	                        headline),
	                    mithril("i", { class: "fas fa-chevron-" + (isOpen ? 'down' : 'up') + " ml1" })),
	                mithril("div", { class: "acc-section " + (isOpen ? 'acc-section--open' : ''), style: "max-height: " + (isOpen ? maxHeight : 0) + "px" },

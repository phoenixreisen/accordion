(function () {
	...
	function scrollTo(itemnr, isOpen, duration) {
	    setTimeout(function () {
	...
	var Accordion = {
	    ...
	    oncreate: function () {
	        window.onload = function () {
	            var items = document.querySelectorAll('.acc-section');
	    ...
	    view: function (_a) {
	        ...
	        return (mithril("section", { class: "accordion" }, (_b = attrs.items) === null || _b === void 0 ? void 0 : _b.map(function (item, index) {
	            ...
	            var isOpen = (index === openPrimary || index === openSecondary);
	            return (mithril("article", { id: "acc-item-" + index, class: "acc-item acc-" + type },
	                mithril("a", { href: "javascript:", onclick: function () { return toggle(state, index, type); }, class: "acc-opener " + (type === 'secondary' ? 'acc-opener--grayed' : '') },
	                    mithril("span", null,
	                        mithril("i", { class: "fas fa-" + fas + " mr1" }),
	                        " ",
	                        headline),
	                    mithril("i", { class: "fas fa-chevron-" + (isOpen ? 'down' : 'up') + " ml1" })),
	                mithril("div", { class: "acc-section acc-animated " + (isOpen ? 'acc-section--open' : '') },

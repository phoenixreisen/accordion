(function () {
	    ...
	    content: {
	        view: function () {
	            return ([
	                ...
	                mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua."),
	                mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua."),
	...
	var Item2 = {
	    ...
	    content: {
	        view: function () {
	            return ([
	                mithril("img", { src: "./phoenix-reisen-flotte.jpg", alt: "Phoenix Flotte", class: "img right" }),
	                mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum."),
	                mithril("p", null, "Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat."),
	                mithril("p", null, "Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."),
	                mithril("div", { class: "clear" })
	    ...
	    content: {
	        view: function () {
	            return ([
	                mithril("p", null, "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum."),
	                mithril("p", null, "Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat."),
	                mithril("img", { src: "./phoenix-reisen-flotte.jpg", alt: "Phoenix Flotte", class: "img full" }),
	                mithril("p", null, "Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."),
	                mithril("p", null, "Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."),
	                mithril("p", null, "Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."),
	                mithril("p", null, "Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi."),
	...
	function getMaxHeight($container) {
	    if ($container) {
	        ...
	        var margin = parseInt(style.margin);
	        var padding = parseInt(style.padding);
	        return (height + (2 * margin) + (2 * padding));
	    }
	    return 0;
	}
	function scrollTo($item, isOpen, delay, jumpMinus) {
	    if (delay === void 0) { delay = 500; }
	    if (jumpMinus === void 0) { jumpMinus = 0; }
	    setTimeout(function () {
	...
	function toggle(state, attrs, itemnr, type) {
	    var _a, _b, _c;
	    var openPrimary = state.openPrimary, openSecondary = state.openSecondary;
	    var jumpMinus = attrs.jumpMinus;
	    var $item = (_a = document.querySelector("#acc-item-".concat(itemnr))) !== null && _a !== void 0 ? _a : null;
	    var $section = (_b = $item === null || $item === void 0 ? void 0 : $item.querySelector('.acc-section')) !== null && _b !== void 0 ? _b : null;
	    var $inner = (_c = $section === null || $section === void 0 ? void 0 : $section.children.item(0)) !== null && _c !== void 0 ? _c : null;
	    var clicked = (type === 'primary'
	        ? openPrimary
	        : openSecondary);
	    var isOpen = (clicked.itemnr === itemnr);
	...
	var Accordion = {
	    ...
	    view: function (_a) {
	        ...
	        var openPrimary = state.openPrimary, openSecondary = state.openSecondary;
	        return (mithril("section", { class: "accordion" }, (_b = attrs.items) === null || _b === void 0 ? void 0 : _b.map(function (item, index) {
	            var headline = item.headline, fas = item.fas, content = item.content, type = item.type;
	            var isOpen = (index === openPrimary.itemnr || index === openSecondary.itemnr);
	            var maxHeight = (type === 'primary' && openPrimary.maxheight)
	                || (type === 'secondary' && openSecondary.maxheight)
	                || 0;
	            return (mithril("article", { id: "acc-item-".concat(index), class: "acc-item ".concat(isOpen ? 'acc-open-item' : '', " acc-").concat(type) },
	                mithril("a", { href: "javascript:", onclick: function () { return toggle(state, attrs, index, type); }, class: "acc-opener ".concat(type === 'secondary' ? 'acc-opener--grayed' : '') },
	                    mithril("span", null,
	                        mithril("i", { class: "fas fa-".concat(fas, " mr1") }),
	                        " ",
	                        headline),
	                    mithril("i", { class: 'fas fa-chevron-up ml1' })),
	                mithril("div", { class: 'acc-section', style: "max-height: ".concat(isOpen ? maxHeight : 0, "px") },
	                    mithril("div", { class: "acc-inner" }, mithril(content)))));
	        })));
	    },
	};
	...
	var Demo = {
	    view: function () {
	        return (mithril("div", { class: "acc-demo" },
	            mithril(Accordion, { items: [0, 1, 2, 1, 3, 0, 2, 2, 1, 3, 0, 1, 2, 3].map(function (current) {

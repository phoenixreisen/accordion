	    ...
	    view: function (_a) {
	        ...
	        return (mithril("section", { class: "accordion" }, (_b = attrs.items) === null || _b === void 0 ? void 0 : _b.map(function (item, index) {
	            ...
	            var maxHeight = (type === 'primary' && openPrimary.maxheight)
	                ...
	                || 0;
	            return (mithril("article", { id: "acc-item-" + index, class: "acc-item " + (isOpen ? 'acc-open-item' : '') + " acc-" + type },
	                ...
	                mithril("div", { class: 'acc-section', style: "max-height: " + (isOpen ? maxHeight : 0) + "px" },

(function () {
	...
	function getMaxHeight(itemnr) {
	    var $item = document.querySelector("#acc-item-" + itemnr + " .acc-section");
	    var $inner = $item.children.item(0);
	    var style = window.getComputedStyle($inner);
	    var margin = parseInt(style.margin, 10);
	    var padding = parseInt(style.padding, 10);
	    var height = $inner.offsetHeight;
	    return (height + (2 * margin) + (2 * padding));
	}
	function scrollTo(itemnr, isOpen, duration, jumpMinus) {
	    if (duration === void 0) { duration = 500; }
	    if (jumpMinus === void 0) { jumpMinus = 0; }
	    setTimeout(function () {
	        var item = document.querySelector("#acc-item-" + itemnr);
